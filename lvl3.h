...
public:
         ...
         Silnik_Obrazen& silauderzenia) 
    {
        ...
        FizycznyObiekt* stropDrewnoP1 = new FizycznyObiekt(worldId, mat_drw_belka, 1590.f, 780.f, 120.f, 40.f, TypKsztaltu::PROSTOKAT);
        ...
        // Kolejność: Czerwony, Niebieski, Żółtek, Bomba, Czerwony
        // =========================================================================
